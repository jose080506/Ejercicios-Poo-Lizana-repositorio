...
public:
    ...
    void setupUi(QWidget *Login)
    {
        ...
        lClima = new QLabel(Login);
        lClima->setObjectName("lClima");

        gridLayout->addWidget(lClima, 5, 0, 1, 1);

        lHora = new QLabel(Login);
        lHora->setObjectName("lHora");
        lHora->setAlignment(Qt::AlignRight|Qt::AlignVCenter);

        gridLayout->addWidget(lHora, 5, 1, 1, 1);
    ...
    void retranslateUi(QWidget *Login)
    {
        ...
        lClima->setText(QCoreApplication::translate("Login", "Cargando clima...", nullptr));
        lHora->setText(QCoreApplication::translate("Login", "--:--:--", nullptr));
    } // retranslateUi
