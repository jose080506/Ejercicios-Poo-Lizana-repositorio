...
template <> constexpr inline auto EditorPrincipal::qt_create_metaobjectdata<qt_meta_tag_ZN15EditorPrincipalE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        // Slot 'slot_cambiarLenguaje'
        QtMocHelpers::SlotData<void(int)>(1, 2, QMC::AccessPrivate, QMetaType::Void, {{
            { QMetaType::Int, 3 },
        }}),
        // Slot 'slot_lineaCambiada'
        QtMocHelpers::SlotData<void()>(4, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'slot_exportarJpg'
...
void EditorPrincipal::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->slot_cambiarLenguaje((*reinterpret_cast<std::add_pointer_t<int>>(_a[1]))); break;
        case 1: _t->slot_lineaCambiada(); break;
        case 2: _t->slot_exportarJpg(); break;
        default: ;
        }
    }
}
