...
void Login::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->demasiadosIntentos(); break;
        case 2: _t->slot_validarUsuario(); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (Login::*)()>(_a, &Login::loginExitoso, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (Login::*)()>(_a, &Login::demasiadosIntentos, 1))
            return;
    }
}
